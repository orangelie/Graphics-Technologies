#include "pch.h"
#include "00. EmptyDemo.h"
#include "Camera.h"
#include "Input.h"
#include "PointerContainer.h"

void EmptyDemo::Start()
{
...
void EmptyDemo::Update(float dt)
{
    // Camera Movement
...
void EmptyDemo::Resize(uint32 width, uint32 height)
{
    if (_device != nullptr)
    {
        // SETUP
...
void EmptyDemo::CreateD3D11DeviceAndSwapChain()
{
...
void EmptyDemo::CreateMainRTVAndDSV()
{
    {
...
void EmptyDemo::CreateRasterizerState()
{
...
void EmptyDemo::CreateSamplerState()
{
...
Vec3 EmptyDemo::GetLocalDirectionVector(Vec3 dir)
{
